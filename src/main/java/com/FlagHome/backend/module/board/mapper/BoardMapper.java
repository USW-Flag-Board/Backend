package com.FlagHome.backend.module.board.mapper;

import com.FlagHome.backend.module.board.controller.dto.BoardRequest;
...
public interface BoardMapper {
     ...
     * Version 2
     */
    Board mapFrom(BoardRequest boardRequest);
}
