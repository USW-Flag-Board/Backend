...
//
//import com.FlagHome.backend.domain.post.v1.controller.PostController;
//import com.FlagHome.backend.global.common.Status;
//import com.FlagHome.backend.domain.board.v1.entity.Board;
//import com.FlagHome.backend.domain.like.v1.service.LikeService;
//import com.FlagHome.backend.domain.member.entity.Member;
//import com.FlagHome.backend.domain.post.v1.controller.dto.CreatePostRequest;
//import com.FlagHome.backend.domain.post.v1.controller.dto.GetPostResponse;
//import com.FlagHome.backend.domain.post.v1.entity.Post;
//import com.FlagHome.backend.domain.post.v1.service.PostService;
...
//        dummyBoard.setId(1L);
//
//        dummyMember = Member.builder().name("gildong").email("gildong@naver.com").loginId("gildong123").password("123123").phoneNumber("010-444-4444").build();
//
